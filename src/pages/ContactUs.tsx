      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="md:flex">
            ...
            <div className="md:w-1/3 bg-gradient-to-br from-meddoc-fonce to-meddoc-primary p-8 text-white">
              ...
              <div className="space-y-6 mt-12">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">contact@meddoc.mg</p>
                  </div>
                </div>
              ...
              <div className="mt-16">
                <p className="text-sm opacity-75">Suivez-nous</p>
            ...
            <div className="md:w-2/3 p-8">
              <h2 className="text-3xl font-bold mb-8 text-meddoc-fonce">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <div className="space-y-2">
                    <Label className="font-medium text-sm text-gray-700 flex items-center">
                      <User className="h-4 w-4 mr-2 text-meddoc-primary" />
                      Nom
                    </Label>
                    <div className="relative">
                      <Input
                        ...
                        className="w-full bg-gray-50 border border-gray-200 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-meddoc-primary/20 focus:border-meddoc-primary transition-all"
                      />
                    </div>
                    {errors.nom && (
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Select onValueChange={field.onChange} value={field.value}>
                          <SelectTrigger className="bg-gray-50 w-full border border-gray-200 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-meddoc-primary/20 focus:border-meddoc-primary transition-all">
                ...
                <div className="space-y-2 mb-6">
                  <Label className="font-medium text-sm text-gray-700 flex items-center">
                    <Building className="h-4 w-4 mr-2 text-meddoc-primary" />
                    Service concerné
                  </Label>
                  <Controller
                    name="service"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <div className="space-y-2">
                    <Label className="font-medium text-sm text-gray-700 flex items-center">
                      <Mail className="h-4 w-4 mr-2 text-meddoc-primary" />
                      Email
                    </Label>
                    <div className="relative">
                      <Input
                  ...
                  <div className="space-y-2">
                    <Label className="font-medium text-sm text-gray-700 flex items-center">
                      <Phone className="h-4 w-4 mr-2 text-meddoc-primary" />
                      Téléphone
                    </Label>
                    <div className="relative">
                      <Input
                ...
                <div className="space-y-2 mb-8">
                  <Label className="font-medium text-sm text-gray-700 flex items-center">
                    <MessageSquare className="h-4 w-4 mr-2 text-meddoc-primary" />
                    Votre message
                  </Label>
                  <textarea
                    {...register("message")}
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-meddoc-primary to-meddoc-secondary hover:from-meddoc-primary/90 hover:to-meddoc-secondary/90 text-white py-3 px-6 rounded-lg font-medium transition-all flex items-center justify-center"
